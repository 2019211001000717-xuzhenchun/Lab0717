...
public class CalServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        double firstVal=request.getParameter("firstVal")!=null?Double.parseDouble(request.getParameter("firstVal")):0;
        double secondVal=request.getParameter("secondVal")!=null?Double.parseDouble(request.getParameter("secondVal")):0;
        ...
        response.sendRedirect("/lab_war_exploded/lab3/cal.jsp");
    }
}
